# Contributing to test-answer-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
test-answer-schema. These guidelines are not strict rules.
...
The test-answer-schema team strives to create a
...
[issues]: https://github.com/sierra-moxon/test-answer-schema/issues/
[pulls]: https://github.com/sierra-moxon/test-answer-schema/pulls/
